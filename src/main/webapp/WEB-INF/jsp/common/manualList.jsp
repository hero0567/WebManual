...
<section  class="ledao-category-manual-tab" class="row">
						...
						<div class="f-l">
				            ...
				            <ul class="tabUl">
				                <li class="tabtr clearfix">
				                    <span style="width: 20%">海尔液晶电视HXXGD说明书1</span>
				...
				<tab heading="冰箱">
					<div class="sublist">
						<div class="f-l">
				            ...
				            <ul class="tabUl">
				                <li class="tabtr clearfix">
				                    <span style="width: 20%">海尔液晶电视HXXGD说明书2</span>
					                <span style="width: 10%">海尔</span>
					                <span style="width: 15%">HXXGD</span>
					                <span style="width: 10%">液晶电视</span>
					                <span style="width: 10%"><a href="">详细信息</a></span>
				...
				<tab heading="洗衣机">
					<div class="sublist">
						<div class="f-l">
				            ...
				            <ul class="tabUl">
				                <li class="tabtr clearfix">
				                    <span style="width: 20%">海尔液晶电视HXXGD说明书3</span>
					                <span style="width: 10%">海尔</span>
					                <span style="width: 15%">HXXGD</span>
					                <span style="width: 10%">液晶电视</span>
					                <span style="width: 10%"><a href="">详细信息</a></span>
