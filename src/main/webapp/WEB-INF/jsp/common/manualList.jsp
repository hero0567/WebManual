...
<link rel="stylesheet" type="text/css" href="css/pages/manualList.css" />
<script src="js/lib/others/ldt_abs.js"></script>
<script src="js/lib/others/scroll.js"></script>

<section class="ledao-category-manual-tab">	
	<div class="manual-category_head" class="layout">
	    <h3 class="section-title">大家电类说明书</h3> 
	...
	<ul id="ledao-manual-list-1" class="tabbtn">
...
<section class="ledao-category-manual-tab">	
	<div class="manual-category_head" class="layout">
	    <h3 class="section-title">生活家电类说明书</h3> 
...
<section class="ledao-category-manual-tab">	
	<div class="manual-category_head" class="layout">
	    <h3 class="section-title">厨卫家电类说明书</h3> 
...
<section class="ledao-category-manual-tab">	
	<div class="manual-category_head" class="layout">
	    <h3 class="section-title">个人护理类说明书</h3> 
